...
const h1Style = 'text-2xl md:text-3xl text-white font-bold ';
const pStyle = '';
export default function Hero() {
    return (
        <div className='w-full flex flex-col md:flex-row justify-between p-20'>
            <div className='w-full md:w-[60%]'>
                ...
                <div className='my-2 md:my-10 '>
                    <button className='text-white py-2 px-4 md:mr-4 rounded-md bg-green-700 hover:bg-slate-950'>Work with me</button>
                    <button className='py-2 px-4 mx-4 rounded-md bg-slate-800 hover:bg-slate-950'>See my past work</button>
                </div>
            </div>
